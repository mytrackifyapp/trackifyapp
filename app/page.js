      ...
      <footer className="bg-white relative z-10">
        <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-2">
            <Link href="https://x.com/TrackifyAI/" className="text-gray-400 hover:text-gray-500 transition-colors">
            ...
            <Link href="https://www.instagram.com/mytrackifyapp/" className="text-gray-400 hover:text-gray-500 transition-colors">
              ...
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M12 2.163c3.204 0 3.584.012 4.849.07 1.366.062 2.633.332 3.608 1.308.975.975 1.246 2.242 1.308 3.608.058 1.265.07 1.645.07 4.849s-.012 3.584-.07 4.849c-.062 1.366-.332 2.633-1.308 3.608-.975.975-2.242 1.246-3.608 1.308-1.265.058-1.645.07-4.849.07s-3.584-.012-4.849-.07c-1.366-.062-2.633-.332-3.608-1.308-.975-.975-1.246-2.242-1.308-3.608-.058-1.265-.07-1.645-.07-4.849s.012-3.584.07-4.849c.062-1.366.332-2.633 1.308-3.608.975-.975 2.242-1.246 3.608-1.308 1.265-.058 1.645-.07 4.849-.07zm0-2.163C8.741 0 8.332.014 7.052.072 5.773.13 4.68.392 3.757 1.315 2.834 2.238 2.572 3.331 2.514 4.61 2.456 5.89 2.442 6.299 2.442 12s.014 6.11.072 7.39c.058 1.279.32 2.372 1.243 3.295.923.923 2.016 1.185 3.295 1.243 1.279.058 1.688.072 7.39.072s6.11-.014 7.39-.072c1.279-.058 2.372-.32 3.295-1.243.923-.923 1.185-2.016 1.243-3.295.058-1.279.072-1.688.072-7.39s-.014-6.11-.072-7.39c-.058-1.279-.32-2.372-1.243-3.295-.923-.923-2.016-1.185-3.295-1.243C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zm0 10.162a3.999 3.999 0 110-8 3.999 3.999 0 010 8zm6.406-11.845a1.44 1.44 0 100-2.88 1.44 1.44 0 000 2.88z" />
              </svg>
            </Link>
          </div>
